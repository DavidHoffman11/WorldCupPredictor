    ...
    for group in groupsToRun:
        for i in range(len(group) - 1):
            ...
            for j in range(i + 1, len(group)):
                ...
                predictor.at[0,'att'] = team1WC['att'].iloc[0] - team2WC['att'].iloc[0]
                predictor.at[0,'mid'] = team1WC['mid'].iloc[0] - team2WC['mid'].iloc[0]
                predictor.at[0,'def'] = team1WC['def'].iloc[0] - team2WC['def'].iloc[0]
                predictor.at[0,'ovr'] = team1WC['ovr'].iloc[0] - team2WC['ovr'].iloc[0]
...
def simulateKnockOutGame(teamName1, teamName2, worldCup):
    ...
    if predictedVal == 1:
        ...
        if team1WC['ovr'].iloc[0] > team2WC['ovr'].iloc[0]:
